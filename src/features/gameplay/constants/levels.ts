...
export const GAME_LEVELS = [
  {
    ...
    initialCreatures: [
      ...
      creature('creature-caballo', 'caballo', 'caballo', 'animals', 31, 49, 'lavender', 'drift', -3.4, 7.6),
      creature('creature-coche', 'coche', 'coche', 'transport', 68, 55, 'mint', 'bob', -2.8, 6.1),
      creature('creature-pajaro', 'pajaro', 'pájaro', 'animals', 43, 67, 'berry', 'sway', -1.7, 7.9),
    ],
    respawnCreatures: [
      ...
      creature('spawn-ventana', 'ventana', 'ventana', 'home', 64, 48, 'lavender', 'sway', -1.9, 7.5),
    ],
  },
  {
    id: 'food-1',
    ...
    initialCreatures: [
      ...
      creature('creature-manzana', 'manzana', 'manzana', 'food', 32, 50, 'lavender', 'drift', -3.1, 7.5),
    ...
    respawnCreatures: [
      ...
      creature('spawn-coche-2', 'coche', 'coche', 'transport', 73, 24, 'lavender', 'sway', -2.2, 7.2),
